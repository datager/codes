...
const (
	...
	TaskStatus_Task_Status_Feature    TaskStatus = 8
)
...
func (m *QueryTimeRange) GetTimestampStart() int64 {
	if m != nil {
...
func (m *QueryTimeRange) GetTimestampEnd() int64 {
	if m != nil {
...
func (m *QueryTimeSpacialRange) GetRepoId() int32 {
	if m != nil {
		return m.RepoId
	}
	return 0
...
func (m *QueryTimeSpacialRange) GetSensorIds() []int32 {
	if m != nil {
		return m.SensorIds
	}
	return nil
...
func (m *BaseQuery) GetQueryId() string {
	if m != nil {
		return m.QueryId
	}
	return ""
...
func (m *BaseQuery) GetType() ObjType {
	if m != nil {
		return m.Type
	}
...
func (m *BaseQuery) GetColumns() []string {
	if m != nil {
		return m.Columns
	}
	return nil
...
func (m *BaseQuery) GetOffset() int32 {
	if m != nil {
		return m.Offset
	}
	return 0
...
func (m *BaseQuery) GetLimit() int32 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *BaseQuery) GetSortBy() string {
	if m != nil {
		return m.SortBy
	}
	return ""
...
func (m *BaseQuery) GetSortOrderAsc() bool {
	if m != nil {
		return m.SortOrderAsc
	}
	return false
}

func (m *BaseQuery) GetGroupByDimensions() GroupByDimensions {
	if m != nil {
		return m.GroupByDimensions
	}
	return GroupByDimensions_UNKNOWN_DIMENSION
}

func (m *BaseQuery) GetOutputFmt() DataFmtType {
	if m != nil {
		return m.OutputFmt
	}
...
func (m *BaseQuery) GetFeature() []byte {
	if m != nil {
		return m.Feature
	}
	return nil
...
func (m *DimensionalCountRequest) GetCountDimension() CountDimensions {
	if m != nil {
		return m.CountDimension
	}
	return CountDimensions_COUNT_DIMENSION_UNKNOWN
}
...
func (m *ObjCount) GetCount() int32 {
	if m != nil {
		return m.Count
	}
	return 0
