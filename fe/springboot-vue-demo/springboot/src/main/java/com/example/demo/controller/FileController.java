...
public class FileController extends BaseController {
    ...
    String filePathPrefix = "/springboot/src/main/resources/files/";
    ...
    public Result<?> upload(MultipartFile file) throws IOException {
        ...
        String rootFilePath = System.getProperty("user.dir") + filePathPrefix + flag + "_" + originalFilename;  // 获取上传的路径
    ...
    public void getFiles(@PathVariable String flag, HttpServletResponse response) {
        ...
        String basePath = System.getProperty("user.dir") + filePathPrefix;  // 定于文件上传的根路径
